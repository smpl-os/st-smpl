...
static Key key[] = {
	...
	/* Ctrl+Backspace -> \x17 (Ctrl+W) so readline (bash/fish/zsh) and modern
	 * CLIs (Copilot CLI, opencode, Claude Code) treat it as unix-word-rubout.
	 * micro must bind "CtrlW": "DeleteWordLeft" to keep the same behaviour. */
